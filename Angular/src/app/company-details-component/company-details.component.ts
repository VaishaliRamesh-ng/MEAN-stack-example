...
export class CompanyDetailsComponent implements OnInit {
  employees$ = {} as WritableSignal<company_details[]>;
  ...
  constructor(private _global_service: global_service) {}
  ...
  deleteEmployee(id: string): void {
    this._global_service.deleteComapnyRecord(id).subscribe({
      next: () => this.fetchEmployees(),
    });
  }

  private fetchEmployees(): void {
    this.employees$ = this._global_service.company_list$;
    this._global_service.getCompanyList();
  }
}